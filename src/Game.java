...
public class Game extends Object 
{
     ...
     * reset the current and next figure and print a game over message.
     */
    ...
    private void handleFigureLanded() 
    {
        ...
        if (board.hasFullLines()) 
        {
            ...
            if (level < 11 && board.getRemovedLines() / 20 > level) 
            {
    ...
    private class GameThread extends Thread 
    {
         ...
         * steps initially and smaller as the level increases. A level 
    ...
    private class GamePanel extends Container 
    {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1686487856328157162L;
